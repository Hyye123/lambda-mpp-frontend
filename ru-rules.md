# **Правила сайта Lambda Multiplayer Piano**
...
[Оригинальные правила MPPNet](https://docs.google.com/document/d/1uQaTzxNy06AWPfinQxgBEF8ea_IjvoGweZjmvp6tEsQ/edit?usp=sharing) были взяты за основу

# **Список того, что запрещено**

Нажми на синий текст, чтобы изучить подробнее каждый пункт.

* [Дискриминация по цвету кожи, состоянию психического или физического здоровья, полу или другим личным качествам](#дискриминация)  
* [Сексуальный или жестокий контент](#неприемлемый-контент)  
* [Обсуждение членовредительства или других очень негативных тем](#обсуждение-членовредительства-или-других-очень-негативных-тем)  
* [Спам пианино или чата в лобби](#спам-пианино-или-чата-в-лобби)  
* [Использование множества пользовательских ID для обхода банов сайта, кикбанов, мьютов другими пользователями](#обход-банов-или-мьютов)  
* [Злоупотребление багами](#злоупотребление-багами)  
* [Фишинг и IP-обнаружители](#фишинг-и-ip-обнаружители)  
* [Злоупотребление ботами или скриптами](#злоупотребление-ботами-или-скриптами), больше информации об этом [здесь](https://github.com/Hyye123/lambda-mpp-frontend/blob/main/ru-bot-guide.md)  
* [Пропаганда насилия, незаконных или опасных действий на сайте](#пропаганда-насилия,-незаконных-или-опасных-действий-на-сайте)  
* [Пропаганда нарушения правил](#пропаганда-нарушения-правил)  
* [Разглашение личной информации другого пользователя без его согласия](#разглашение-личной-информации-другого-пользователя-без-его-согласия)  
* [Отправка одного и того же сообщения в несколько комнат](#отправка-одного-и-того-же-сообщения-в-несколько-комнат)  
* [Удержание короны в комнате, которая вам не принадлежит](#удержание-короны-в-комнате,-которая-вам-не-принадлежит)  
* [Злоупотребление разрешениями или более высокими квотами (ограничениями)](#злоупотребление-разрешениями-или-более-высокими-квотами-\(ограничениями\))  
* [Негативное введение других пользователей в заблуждение](#негативное-введение-других-пользователей-в-заблуждение)
...
## **Неприемлемый контент** {#неприемлемый-контент}
...
## **Обход банов или мьютов** {#обход-банов-или-мьютов}
...
Если вы обнаружили неисправность на сервере, пожалуйста, сообщите об этом, написав на мне в Discord (hyye.xyz). Поиск и тестирование неисправностей разрешены, если это ничему не вредит. Злоупотребление неисправностью приведет к бану.
...
## **Злоупотребление ботами или скриптами** {#злоупотребление-ботами-или-скриптами}

Основную информацию по этой теме можно найти [здесь](https://github.com/Hyye123/lambda-mpp-frontend/blob/main/ru-bot-guide.md). Как правило, вы должны использовать ботов и скрипты только с добрыми намерениями.
...
Вы можете попросить у меня в Discord (hyye.xyz) более высокую квоту нот для воспроизведения [Black MIDI](https://ru.wikipedia.org/wiki/%D0%91%D0%BB%D1%8D%D0%BA-%D0%BC%D0%B8%D0%B4%D0%B8) (файлов с большим количеством нот) . Тем не менее, вы должны использовать его ответственно. Не раздражайте этим людей и играйте Black MIDI только в тех комнатах, в которых владелец не против. То же самое относится и к любому другому разрешению или квоте, которые вам могут быть предоставлены.

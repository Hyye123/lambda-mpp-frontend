# **Lambda Multiplayer Piano Site Rules**

[Русский (Russian)](https://github.com/Hyye123/lambda-mpp-frontend/blob/main/ru-rules.md)
...
[Original MPPNet rules](https://docs.google.com/document/d/1wQvGwQdaI8PuEjSWxKDDThVIoAlCYIxQOyfyi4o6HcM/edit?usp=sharing) were used as a basis.
...
* [Abusing bots or scripts](#bookmark=id.upsalt4k3ygi), see more information about this [here](https://github.com/Hyye123/lambda-mpp-frontend/blob/main/bot-guide.md)  
...
If you find a bug in the server, please message me in discord (hyye.xyz). Attempting to find bugs and testing bugs is allowed as long as it doesn’t damage anything. Abusing a bug will result in a ban.
...
The main page on this subject can be found [here](https://github.com/Hyye123/lambda-mpp-frontend/blob/main/bot-guide.md). Generally, you should only use bots and scripts with good intention.
...
If you ask me on discord (hyye.xyz) for a higher note quota to play black midis, I am not stingy about it and will likely give it to you. However, you’re expected to use it responsibly. Don’t annoy people with it and only play black midis in rooms where the owner is ok with it. The same idea goes for any other permission or quota you may be given.
